...
public class TableJavaFxExampleaGetOrder extends Application{
...
//       }
       public Scene createScene3(){
             ...
             TableColumn thirdNameCol = new TableColumn("summa");
             TableColumn fourdNameCol = new TableColumn("contructor");
             TableColumn fiveNameCol = new TableColumn("user");
             ...
             OrderServiceImpl orderServiceImpl = new OrderServiceImpl(orderDaoImpl); 
...
//                        new Product1(4, "Сардельки", "541")
             ...
             firstNameCol.setCellValueFactory(new PropertyValueFactory<Order,Long>("id"));
             secondNameCol.setCellValueFactory(new PropertyValueFactory<Order,String>("number"));
             thirdNameCol.setCellValueFactory(new PropertyValueFactory<Order,Integer>("summa"));
             fourdNameCol.setCellValueFactory(new PropertyValueFactory<Order,Contructor>("contructor"));
             fiveNameCol.setCellValueFactory(new PropertyValueFactory<Order,User>("user"));
            
             table.setItems(list);
            
             table.getColumns().addAll(firstNameCol,secondNameCol,thirdNameCol,fourdNameCol,fiveNameCol);
